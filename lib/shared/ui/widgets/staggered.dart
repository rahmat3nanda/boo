...
class BooUIStaggered extends StatelessWidget {
  const BooUIStaggered({
  ...
  factory BooUIStaggered.builder({
  ...
  factory BooUIStaggered.separated({
    required int itemCount,
    required Widget Function(int index) separatorBuilder,
    required Widget Function(int index) iteBoouilder,
    double horizontalSpacing = 8,
    double verticalSpacing = 8,
    Axis direction = Axis.horizontal,
    TextDirection? textDirection,
